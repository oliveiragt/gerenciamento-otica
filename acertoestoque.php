        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                foreach($count as $resultado){
                    ?>
                <h2 class="text-center">Acerto de Estoque de <?php echo $resultado['descricao']; ?> </h2>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-3">
            ...
            <div class="col-sm-6">
                ...
                <form name="cadusuarios" method="post" action="acertarestoque.php">
                    <input name="id" type="hidden" class="form-control" value="<?php echo $resultado['idproduto']; ?>"
                        required>
                    <div class="form-row">
                    ...
                    <a href="listarprodutos.php"><button type="button" class="btn btn-outline-secondary">Voltar a lista
                            de produtos</button></a>
                </form>
                <?php } ?>
            </div>
        </div>
